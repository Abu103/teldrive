...
func (CategoryStatsCategory) AllValues() []CategoryStatsCategory {
	return []CategoryStatsCategory{
		CategoryStatsCategoryArchive,
		CategoryStatsCategoryAudio,
		CategoryStatsCategoryDocument,
		CategoryStatsCategoryImage,
		CategoryStatsCategoryOther,
		CategoryStatsCategoryVideo,
	}
}
...
func (s *CategoryStatsCategory) UnmarshalText(data []byte) error {
	switch CategoryStatsCategory(data) {
	case CategoryStatsCategoryArchive:
...
func (o OptFileCategory) IsSet() bool { return o.Set }
