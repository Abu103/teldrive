...
func (s *CategoryStatsCategory) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode CategoryStatsCategory to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
	...
	switch CategoryStatsCategory(v) {
	case CategoryStatsCategoryArchive:
		*s = CategoryStatsCategoryArchive
	case CategoryStatsCategoryAudio:
		*s = CategoryStatsCategoryAudio
	case CategoryStatsCategoryDocument:
		*s = CategoryStatsCategoryDocument
	case CategoryStatsCategoryImage:
		*s = CategoryStatsCategoryImage
	case CategoryStatsCategoryOther:
		*s = CategoryStatsCategoryOther
	case CategoryStatsCategoryVideo:
		*s = CategoryStatsCategoryVideo
	default:
		*s = CategoryStatsCategory(v)
	}
...
// encodeFields encodes fields.
func (s *EventSource) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("id")
		e.Str(s.ID)
	}
...
var jsonFieldsNameOfEventSource = [5]string{
	0: "id",
	1: "name",
	2: "type",
	3: "parentId",
...
func (s *EventSource) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode EventSource to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode EventSource")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfEventSource) {
					name = jsonFieldsNameOfEventSource[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *EventSourceType) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode EventSourceType to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
	...
	// Try to use constant string.
	switch EventSourceType(v) {
	case EventSourceTypeFolder:
		*s = EventSourceTypeFolder
	case EventSourceTypeFile:
		*s = EventSourceTypeFile
	default:
		*s = EventSourceType(v)
	}
...
// encodeFields encodes fields.
func (s *FileListMeta) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("count")
		e.Int(s.Count)
	}
...
var jsonFieldsNameOfFileListMeta = [3]string{
	0: "count",
	1: "totalPages",
	2: "currentPage",
}
...
func (s *FileListMeta) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode FileListMeta to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode FileListMeta")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfFileListMeta) {
					name = jsonFieldsNameOfFileListMeta[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
var jsonFieldsNameOfFilePartsUpdate = [7]string{
	0: "name",
	1: "parentId",
	2: "channelId",
	3: "uploadId",
...
func (o *OptFileCategory) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptFileCategory to nil")
	}
	o.Set = true
